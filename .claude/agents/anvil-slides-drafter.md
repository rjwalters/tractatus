---
name: anvil-slides-drafter
description: Anvil Slides Drafter - Dedicated subagent that executes the `anvil:slides-draft` lifecycle command. Use when running the draft phase of the slides skill, including parallel fan-out.
