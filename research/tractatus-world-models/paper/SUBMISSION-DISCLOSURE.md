...
| `TractatusOntologyExclusion.lean` | 12 (236 ln) | Claude (Anthropic) — new tier for this paper | Claude (Anthropic) — new tier for this paper | Lean 4 kernel; footprint `propext`, `Classical.choice`, `Quot.sound` |
