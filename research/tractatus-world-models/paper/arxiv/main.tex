...
\url{https://github.com/rjwalters/tractatus} (commit \lean{0852c5b}; the
full hash is pinned in Appendix~\ref{app:index}). Theorem
...
\begin{figure}[t]
  ...
  exclusion tiers are not refinement-equivalent: no Horn model realizes
  exactly the image profiles of a nontrivial exclusion model
...
\url{https://github.com/rjwalters/tractatus}, pinned at commit
\begin{center}
\lean{0852c5b00e1d2942d39cf4067b0816409cac54f9}
\end{center}
(short: \lean{0852c5b}); at that commit the build is warning-free under
Lean~4.26 with no \lean{sorry}s.
