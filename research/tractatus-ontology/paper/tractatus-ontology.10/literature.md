...
- **Harmonic Aristotle (2026)**: Automated theorem prover for Lean 4 (https://aristotle.harmonic.fun). Produced the proofs in TractatusNOperator.lean and TractatusCompleteness.lean from our sorried statements (projects c15df233 / 212b28eb, 2026-07-12); statements unchanged, re-verified on our pinned toolchain, standard axioms only. Attributed in Acknowledgments.
...
4. **The equivalence separation** — syntactic identity (structEq) strictly refines both logical-form equivalence (formEq) and semantic equivalence (semEq), and formEq and semEq are themselves provably **incomparable** (they do NOT form a chain: neither is contained in the other), with strict separation witnesses; prior work discusses logical form informally
