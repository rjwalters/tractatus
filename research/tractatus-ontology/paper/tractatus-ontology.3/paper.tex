...
(Theorem~\texttt{formEq\_implies\_\allowbreak{}truth\_table\_iso}):
there exists a world-relabeling $f$ such that
...
\Lean~4.  The formalization proves 50 formally verified results
...
\begin{enumerate}[nosep]
  ...
  \item The \texttt{lean-toolchain} file pins the version to
    {\small\ttfamily leanprover/lean4:v4.17.0}.
...
40 & \texttt{nontrivial\_expressibility\_requires\_world\_dependence}
                                                         & 4.12    & Ont. & L \\
41 & \texttt{nontrivial\_cannot\_express\_world\_independent}
                                                         & 4.12    & Ont. & L \\
\midrule
\multicolumn{5}{l}{\emph{TractatusQuantifiers.lean} (9 declarations)} \\
\midrule
42 & \texttt{truth\_functional\_compositionality\_fo}    & 5       & Quant. & I \\
