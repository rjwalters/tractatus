...
The formalization comprises 1,629 lines of \Lean~4, proves 54
...
\begin{enumerate}[nosep, label=(\arabic*)]
  ...
  \item A three-way decomposition of all 54 formalized results
...
\noindent
The formalization comprises 1,629 lines of \Lean~4 across two
files.\footnote{%
  \texttt{TractatusOntology.lean} (1,345 lines, 45 theorem/lemma
  declarations) and \texttt{TractatusQuantifiers.lean} (284 lines,
...
truth-conditional identity cut across each other.
...
offers a formal candidate for the notion his discussion
targets.
...
\Lean~4.  The formalization proves 54 formally verified results
...
\centering
\footnotesize
\caption{Complete listing of all 54 theorem/lemma declarations
